...
![Настройка портов](screenshots/5.png)
...
![Статус Loki](screenshots/21.png)
...
![Результат PromQL](screenshots/26.png)
...
![Фильтрация логов](screenshots/27.png)
...
![Навигация к шаблонам](screenshots/11.png)
...
![Навигация к хостам](screenshots/13.png)
...
![Статус сервера](screenshots/28.png)

*Рисунок 24 — Статус сервера и триггеров в Zabbix*

![Успешная работа Zabbix](screenshots/23.png)
...
![Комбинированный дашборд](screenshots/24.png)
